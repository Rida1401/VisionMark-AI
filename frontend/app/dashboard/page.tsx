          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-xl sm:text-2xl font-bold text-slate-800 tracking-tight">VisionMark AI Dashboard</h1>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 border border-blue-100 mb-6">
              ...
              <span className="text-blue-600 font-bold text-xs uppercase tracking-widest">VisionMark AI Dashboard</span>
            </div>
