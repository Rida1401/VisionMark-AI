  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50">
          ...
          <div className={`space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="space-y-6">
              ...
              <p className="text-xl sm:text-2xl text-slate-600 leading-relaxed max-w-2xl font-medium">
                Transform your attendance management with <span className="font-bold text-slate-900">VisionMark AI</span>. 
      ...
      <div className="absolute bottom-4 right-8 z-20">
        <p className="text-slate-400 text-xs font-medium">Created & Owned by Rida</p>
      </div>
    </section>
  );
}